...
public class Runner {
    public static void main(String[] args) {
        ...
        Comparator<Review> compareReview = (arg1, arg2) -> {
            ...
            int getId = arg1.getId().compareTo(arg2.getId());
        ...
        Review review4 = new Review(4, "плохой товар", 100, "25.01.2024 13:37");
        TreeSet<Review> reviews = new TreeSet<>(compareReview.reversed());
